...
class __TwigTemplate_7ec3a1e933275e62d4eb748df85df0d8 extends Template
{
...
";
    ...
    <div class=\"auth-container\">
        ...
        yield "
                ...
                <p class=\"switch-text\">Déjà un compte ? <a href=\"";
        // line 35
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("login");
        yield "\" class=\"switch-link\">Se connecter</a></p>
            </form>
        </section>
    </div>
";
    ...
    {
        return array (  149 => 35,  134 => 23,  130 => 22,  127 => 21,  121 => 19,  119 => 18,  108 => 9,  95 => 8,  82 => 5,  77 => 4,  64 => 3,  41 => 1,);
    }
    ...
    <div class=\"auth-container\">
        ...
        <section class=\"auth-box\" id=\"inscription\">
            ...
            <form action=\"{{ path('register') }}\" method=\"post\">
                ...
                <button type=\"submit\" class=\"btn\">S'inscrire</button>
                <p class=\"switch-text\">Déjà un compte ? <a href=\"{{ path('login') }}\" class=\"switch-link\">Se connecter</a></p>
            </form>
        </section>
    </div>
{% endblock %}
", "security/register.html.twig", "/Users/brice/Desktop/formation CDA/Symfony/templates/security/register.html.twig");
    }
}
