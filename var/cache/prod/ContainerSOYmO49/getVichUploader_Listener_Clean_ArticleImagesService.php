 ...
 */
class getVichUploader_Listener_Clean_ArticleImagesService extends App_KernelProdDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.article_images'])) {
            return $container->privates['vich_uploader.listener.clean.article_images'];
        }

        return $container->privates['vich_uploader.listener.clean.article_images'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('article_images', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->load('getVichUploader_MetadataReaderService')), $a);
    }
}
