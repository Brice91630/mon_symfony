 ...
 */
class getDebug_Security_Firewall_Authenticator_ApiUsersNewService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['debug.security.firewall.authenticator.api_users_new.inner'] ?? $container->load('getDebug_Security_Firewall_Authenticator_ApiUsersNew_InnerService'));
        ...
        return $container->privates['debug.security.firewall.authenticator.api_users_new'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticatorManagerListener($a);
    }
}
